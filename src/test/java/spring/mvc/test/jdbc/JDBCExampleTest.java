...
public class JDBCExampleTest {
	...
	@Autowired
	private JDBCService databaseJDBCService = null;
	
	@Autowired
	private JdbcTemplate jdbcTemplate = null;  //used for conneting to DBs
	...
	public void queryAllTestTableRecords() {
    	...
    	for (Map<String, Object> row : rows) {
				System.out.println("TEST TABLE test column: " + row.get("TESTCOLUMN"));
		}
	}
