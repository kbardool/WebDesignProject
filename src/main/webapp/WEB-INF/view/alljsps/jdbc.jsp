...
<page:template>
    ...
    <jsp:body>
    	<c:url value="/jdbcSelectAllLibraries" var="jdbcSelectAllLibraries" />
		...
		<h3><b>JDBC Examples</b></h3>

		<br/>
		<a href="${jdbcSelectAllLibraries}"> JDBCContoller- jdbcSelectAllLibraries</a><br/>
		Calling with the value : <b>${jdbcSelectAllLibraries}</b>
		<br/>	
		<br/>
