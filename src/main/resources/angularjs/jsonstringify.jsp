...
<title>Java Spring MVC Framework with AngularJS by Google and
	HTML5</title>
		...
		<div class="container">
			<div class="navbar-header">
				<b><a class="navbar-brand"
					href="${pageContext.request.contextPath}">Spring MVC</a></b>
			</div>
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						aria-expanded="false">Lectures<span class="caret"></span></a>
...
<code id="resultArrayParse"></code>
			...
			<script type="text/javascript">
				var array = [ 'Java Spring MVC', 'REST', 'JDBCTemplate',
						'Maven', true, 2, false ];
				var jsonArray = JSON.stringify(array, null, 2);
				document.getElementById("resultArray").innerHTML = jsonArray;
...
<code id="arrayObjects2"></code>
			...
			<script type="text/javascript">
				...
				document.getElementById("arrayObjects").innerHTML = JSON
						.stringify(arrayObjects, null, 2);
				document.getElementById("arrayObjects2").innerHTML = arrayObjects.udemyCourses[1].title;
			</script>
...
<code id="nestedObjects"></code>
	...
	<footer class="footer">
		<div class="container">
			<br> <font color="green"><b>MLDM Web Design Project -
					K Bardool, A Alazizi </b></font>
		</div>
	</footer>
